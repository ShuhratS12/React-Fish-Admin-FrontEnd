...
import {getAttendedCompetitionsByUser} from "../../../http/competitionCRUD";
...
export default function UserAttendedCompetitions(props) {
    ...
    useEffect(() => {
        setLoading(true);
        getAttendedCompetitionsByUser({userId})
            .then((res) => {
